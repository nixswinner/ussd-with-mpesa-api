...
class AfricasTalkingGateway
{
  ...
  const MOBILE_PAYMENT_URL = "https://api.africastalking.com/payment/mobile";
  ...
  public function promptMobilePaymentCheckout($productName_, $phoneNumber_, $currencyCode_, $amount_, $metadata_) 
  {
    $params = array(
		    "username"     => $this->_username, 
    ...
    $this->_requestUrl  = self::MOBILE_PAYMENT_URL."/checkout/v1";
    ...
    if($this->_responseInfo['http_code'] == self::HTTP_CODE_CREATED) {
      ...
      if ($response->status == "PendingCheckoutResult") {
